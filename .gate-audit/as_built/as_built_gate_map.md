...
| 文書 | 役割 | パス |
|------|------|------|
| 要件定義書 | 「なぜ必要か」を定義 | `as_built/as_built_requirements.md`（v2.1） |
| 仕様書 | 「どう動くか」を定義 | `as_built/as_built_spec.md`（v2.1） |
| 実装計画書 | 「どう作ったか」を定義 | `as_built/as_built_implementation_plan.md`（v2.1） |
